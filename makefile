...
plot_Antwerp: gen/Antwerp/plot_Antwerp.pdf
...
gen/data-preperation/aggregated_df.csv: src/data_prep/data_cleaning.R gen/data/url_listings.csv gen/data/url_reviews.csv
		R --vanilla < src/data_prep/data_cleaning.R
  
gen/pivot/pivot.csv: src/analysis/pivot_table.R gen/data-preperation/aggregated_df.csv
		R --vanilla < src/analysis/pivot_table.R

gen/Antwerp/plot_Antwerp.pdf: src/analysis/antwerp.R gen/pivot/pivot.csv
		R --vanilla < src/analysis/antwerp.R

gen/plot_all/plot_all.pdf: src/analysis/plot_all.R gen/data-preperation/aggregated_df.csv
